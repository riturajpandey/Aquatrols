...
{
    public class TableTmInnerDistributorResult : UITableViewSource
    {
        ...
        public TableTmInnerDistributorResult(TmDistributorResultController controller, List<TmCourseProductVm> tmCourseProductVms)
        {
        ...
        {
            CustCellInnerDistributorReuslt cell = tableView.DequeueReusableCell(cellidentifier) as CustCellInnerDistributorReuslt;
            if (cell == null)
            {
                cell = new UITableViewCell(UITableViewCellStyle.Default, cellidentifier) as CustCellInnerDistributorReuslt;
